...
| **ai-service** | ❌ NOT STARTED | **CẦN TẠO MỚI** |
...
| **AI Chatbot Page** | ❌ NOT STARTED | **CẦN TẠO MỚI** |

### Current Implementation Status
- ✅ **Phase 0-3 Complete:** Auth, User, Doctor, Appointment, Notification
- ❌ **Task3 Not Started:** AI Service & Chat UI
...
|------|--------|-------------|--------|
| **W1** | Sprint 1 | AI Core MVP (Backend) | ▶️ Next |
| **W1-W2** | Sprint 1 | Chat UI (Frontend) | ▶️ Next |
| **W2-W3** | Sprint 2 | Structured Input Form | ▶️ Planned |
| **W3** | Sprint 2 | Dynamic Prompt (BE) | ▶️ Planned |
| **W3-W4** | Sprint 3 | Admin Prompt Management | ▶️ Planned |
| **W4** | Post-Task3 | Error Analysis & Fixes | ▶️ Planned |
