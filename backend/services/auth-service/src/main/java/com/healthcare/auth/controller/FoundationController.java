...
import com.healthcare.auth.dto.response.FoundationOverviewResponse;
...
public class FoundationController {
    ...
    @GetMapping("/ping")
    public ApiResponse<FoundationOverviewResponse> ping() {
        FoundationOverviewResponse overview = new FoundationOverviewResponse(
                properties.getName(),
