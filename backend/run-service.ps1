...
param(
    ...
    [ValidateSet('auth-service', 'user-service', 'doctor-service', 'appointment-service', 'notification-service')]
    [string]$Service,
...
if (-not $env:JWT_SECRET) { $env:JWT_SECRET = 'change-this-before-shared-environments' }
